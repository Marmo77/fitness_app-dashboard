...
const navigationMenuTriggerStyle = cva(
  "group/navigation-menu-trigger inline-flex h-9 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-all outline-none hover:bg-primary/80 focus:bg-primary/80 focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-popup-open:bg-primary/50 data-popup-open:hover:bg-primary/80 data-open:bg-primary/50 data-open:hover:bg-primary/80 data-open:focus:bg-primary/80"
)
